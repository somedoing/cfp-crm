    ...
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <Link
            href="/contacts/new"
            className="border border-gray-300 rounded-lg px-3 py-1.5 text-gray-700 hover:bg-gray-50 transition-colors font-medium text-sm"
          >
            + New
          </Link>
          <Link
            href="/contacts/review"
            className="border border-blue-200 bg-blue-50 text-blue-700 hover:bg-blue-100 rounded-lg px-3 py-1.5 font-medium transition-colors text-sm"
          >
            Review →
          </Link>
          <button
            onClick={downloadCSV}
            className="border border-gray-300 rounded-lg px-3 py-1.5 text-gray-600 hover:bg-gray-50 hover:border-gray-400 transition-colors text-sm"
          >
            ↓ CSV
          </button>
        </div>
      ...
      <div className="flex flex-wrap gap-3 items-center">
        <input
          ...
          className="border border-gray-300 rounded-lg px-3 py-2 w-full sm:min-w-64 sm:w-auto focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        />
