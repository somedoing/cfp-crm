...
const STATUSES = ['Needs Review', 'Ready to Contact', 'Assigned to Jon', 'Contacted', 'Follow-up', 'Positive Response', 'Committed', 'Declined', 'Unresponsive', 'Done', 'Dropped', 'Skipped']
