...
const FIELDS = 'id, display_id, full_name, email, phone, town, state, is_volunteer, is_donor, is_signature_collector, is_press_contact, is_media_contact, volunteer_stage, donor_stage, priority, date_added, do_not_contact, tags'
